...
export default function MobileUploadPage() {
  ...
  const [coughDuration, setCoughDuration] = useState("");
  const [coughDurationUnit, setCoughDurationUnit] = useState<"days" | "weeks" | "months">("days");
    ...
    <div className="animate-fade-in max-w-lg mx-auto">
      ...
      <div className="space-y-5">
        ...
        <div className="space-y-4">
          <div>
            <Label className="text-sm font-semibold">Clinical Information</Label>
            <p className="text-xs text-muted-foreground mt-1">
              Enter information relevant to the patient's current visit.
            </p>
          </div>
          ...
          <div>
            ...
            <Select
              value={cough ? "yes" : "no"}
              onValueChange={(value:any) => setCough(value === "yes")}
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  min="0"
                  value={coughDuration}
                  onChange={(e) => setCoughDuration(e.currentTarget.value)}
                  placeholder="e.g. 3"
              ...
              <div>
                ...
                <Select
                  value={coughDurationUnit}
                  onValueChange={(value) =>
                    setCoughDurationUnit(value as "days" | "weeks" | "months")
                  }
                >
                  <SelectTrigger className="mt-1.5">
                    <SelectValue />
          ...
          <div>
            ...
            <Select
              value={fever ? "yes" : "no"}
              onValueChange={(value) => setFever(value === "yes")}
            >
              <SelectTrigger className="mt-1.5">
                <SelectValue />
              </SelectTrigger>
          ...
          {/* Shortness of breath */}
          <div>
            <Label className="text-sm">Shortness of breath</Label>
            <Select
              value={shortnessOfBreath ? "yes" : "no"}
              onValueChange={(value) =>
                
                setShortnessOfBreath(value === "yes")
              }
            >
              <SelectTrigger className="mt-1.5">
                <SelectValue />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e:ChangeEvent<HTMLInputElement>) => setOxygenSaturation(e.target.value)}
                placeholder="e.g. 96"
                className="mt-1.5 w-full h-10 rounded-md border border-input bg-background px-3 text-sm"
              />
            </div>
