...
import {
  LogIn, UserPlus, Upload, Brain, Activity, FileText, Download,
  CheckCircle2, ChevronRight, Play, Pause, RotateCcw, Eye
} from "lucide-react";
      ...
      <div className="w-full max-w-[260px] space-y-3">
        ...
        >
          <div className="w-full h-9 rounded-md bg-primary flex items-center justify-center text-primary-foreground text-xs font-semibold mt-2 cursor-pointer">
            <AnimatedClick delay={2}>Sign In <ChevronRight className="w-3.5 h-3.5 ml-1" /></AnimatedClick>
          </div>
        </motion.div>
      </div>
    </div>
      ...
      <div className="flex gap-3 flex-1 min-h-0">
        ...
        <div className="flex-1 rounded-lg bg-gray-900 relative overflow-hidden flex items-center justify-center">
          <div className="text-center text-gray-500 text-[10px]">
            <Eye className="w-8 h-8 mx-auto mb-1 text-gray-600" />
            Chest X-Ray PA View
          </div>
          <AnimatePresence>
            {showHeatmap && (
